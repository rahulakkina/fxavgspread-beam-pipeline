...
import static ai.aliz.common.FxRateConstants.FORMATTER;
 ...
 * lessons.
 */
public class FxRateWriteOneFilePerWindow extends PTransform<PCollection<String>, PDone> {
    ...
    public FxRateWriteOneFilePerWindow(String filenamePrefix, Integer numShards) {
    ...
    public static class PerWindowFiles extends FilenamePolicy {
        ...
        @Override
        public ResourceId windowedFilename(final int shardNumber, final int numShards, final BoundedWindow window, final PaneInfo paneInfo, final OutputFileHints outputFileHints) {
        ...
        @Override
        public ResourceId unwindowedFilename(final int shardNumber, final int numShards, final OutputFileHints outputFileHints) {
